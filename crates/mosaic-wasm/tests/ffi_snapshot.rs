...
#[test]
fn wasm_upload_epoch_event_preserves_epoch_id_independently_of_shard_index() {
...
#[test]
fn wasm_advance_upload_job_rejects_unknown_last_error_code() {
    let mut snapshot = retry_waiting_upload_snapshot();
...
#[test]
fn wasm_advance_upload_job_rejects_unknown_last_error_stage() {
    let mut snapshot = retry_waiting_upload_snapshot();
