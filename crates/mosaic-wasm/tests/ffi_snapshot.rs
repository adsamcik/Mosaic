...
#[test]
fn wasm_upload_epoch_event_preserves_shard_cursor_independently_of_effect_id() {
...
#[test]
fn wasm_upload_retry_budget_survives_snapshot_round_trip() {
...
#[test]
fn wasm_advance_upload_job_rejects_invalid_last_effect_id() {
    let mut snapshot = retry_waiting_upload_snapshot();
...
#[test]
fn wasm_advance_upload_job_rejects_unknown_retry_target_phase() {
...
#[test]
fn wasm_advance_upload_job_rejects_oversized_schema_version() {
    let mut snapshot = retry_waiting_upload_snapshot();
...
#[test]
fn wasm_advance_upload_job_rejects_unknown_event_error_code() {
    let snapshot = retry_waiting_upload_snapshot();
...
#[test]
fn wasm_advance_upload_job_rejects_unknown_event_error_code_on_non_retryable() {
    let snapshot = retry_waiting_upload_snapshot();
...
#[test]
fn wasm_advance_album_sync_accepts_valid_snapshot_and_event() {
...
#[test]
fn wasm_advance_album_sync_rejects_unknown_phase_string() {
...
#[test]
fn wasm_advance_album_sync_rejects_unknown_last_error_code() {
    let mut snapshot = retry_waiting_album_sync_snapshot();
...
#[test]
fn wasm_advance_album_sync_rejects_unknown_event_error_code() {
    let snapshot = retry_waiting_album_sync_snapshot();
...
#[test]
fn wasm_upload_unknown_event_kind_returns_invalid_transition() {
    let result = advance_upload_job(
        upload_snapshot("Queued"),
        upload_event("DefinitelyNotAKind", 0, 0, 0),
    );
...
#[test]
fn wasm_album_sync_unknown_event_kind_returns_invalid_transition() {
    let result = advance_album_sync(
        retry_waiting_album_sync_snapshot(),
        album_sync_event("DefinitelyNotAKind", 0),
    );
...
#[test]
fn wasm_upload_event_rejects_error_code_without_presence_flag() {
    ...
    let result = advance_upload_job(upload_snapshot("Queued"), event);
...
#[test]
fn wasm_upload_shard_event_rejects_uploaded_flag_kind_mismatch() {
...
#[test]
fn wasm_metadata_sidecar_rejects_oversized_field_value_length() {
...
#[test]
fn wasm_metadata_sidecar_accepts_field_value_at_cap() {
