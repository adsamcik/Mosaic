...
fn client_error_code_from_u16(value: u16) -> Option<mosaic_client::ClientErrorCode> {
    match value {
        ...
        223 => Some(mosaic_client::ClientErrorCode::ShardIntegrityFailed),
        224 => Some(mosaic_client::ClientErrorCode::LegacyRawKeyDecryptFallback),
        225 => Some(mosaic_client::ClientErrorCode::StreamingChunkOutOfOrder),
        226 => Some(mosaic_client::ClientErrorCode::StreamingTotalChunkMismatch),
        227 => Some(mosaic_client::ClientErrorCode::StreamingPlaintextDivergence),
        ...
        607 => Some(mosaic_client::ClientErrorCode::VideoContainerInvalid),
        608 => Some(mosaic_client::ClientErrorCode::MediaInspectFailed),
        609 => Some(mosaic_client::ClientErrorCode::MediaStripFailed),
        610 => Some(mosaic_client::ClientErrorCode::SidecarFieldOverflow),
        611 => Some(mosaic_client::ClientErrorCode::SidecarTagUnknown),
        612 => Some(mosaic_client::ClientErrorCode::MalformedSidecar),
        613 => Some(mosaic_client::ClientErrorCode::MakerNoteRejected),
        614 => Some(mosaic_client::ClientErrorCode::ExifTraversalLimitExceeded),
        615 => Some(mosaic_client::ClientErrorCode::VideoTooLargeForV1),
        616 => Some(mosaic_client::ClientErrorCode::VideoSourceUnreadable),
        617 => Some(mosaic_client::ClientErrorCode::VideoTierShapeRejected),
        ...
        707 => Some(mosaic_client::ClientErrorCode::ManifestShapeRejected),
        708 => Some(mosaic_client::ClientErrorCode::IdempotencyExpired),
        709 => Some(mosaic_client::ClientErrorCode::ManifestSetConflict),
        710 => Some(mosaic_client::ClientErrorCode::BackendIdempotencyConflict),
        711 => Some(mosaic_client::ClientErrorCode::VideoPosterExtractionFailed),
        800 => Some(mosaic_client::ClientErrorCode::PinValidationFailed),
        _ => None,
    }
}
