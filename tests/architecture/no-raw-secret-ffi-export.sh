...
allowlist = {
    ...
    # CORPUS-DRIVER-ONLY: gated by feature='cross-client-vectors'; production builds do not expose this symbol. See SPEC-R-C5.5-MigrationDesign.md §3 and crates/mosaic-uniffi/Cargo.toml. The raw-secret input is consumed by the cross-client link_keys.json corpus parity test.
    ...
    # CORPUS-DRIVER-ONLY: gated by feature='cross-client-vectors'; production builds do not expose this symbol. See SPEC-R-C5.5-MigrationDesign.md §3 and crates/mosaic-uniffi/Cargo.toml. The raw-seed input is consumed by the cross-client identity.json corpus parity test.
    ...
    # CORPUS-DRIVER-ONLY: gated by feature='cross-client-vectors'; production builds do not expose this symbol. See SPEC-R-C5.5-MigrationDesign.md section 4 and crates/mosaic-uniffi/Cargo.toml. The raw-seed input is consumed by the cross-client sealed_bundle.json corpus parity test.
