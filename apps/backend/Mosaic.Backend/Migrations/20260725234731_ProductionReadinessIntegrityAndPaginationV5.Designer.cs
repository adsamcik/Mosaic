...
namespace Mosaic.Backend.Migrations
{
    ...
    [Migration("20260725234731_ProductionReadinessIntegrityAndPaginationV5")]
    partial class ProductionReadinessIntegrityAndPaginationV5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mosaic.Backend.Data.Entities.Album", b =>
                {
                    ...
                    b.Property<byte[]>("MemberRosterSignature")
                        .HasColumnType("bytea")
                        .HasColumnName("member_roster_signature");

                    b.Property<int?>("MemberRosterSignerEpochId")
                        .HasColumnType("integer")
                        .HasColumnName("member_roster_signer_epoch_id");

                    b.Property<long?>("MemberRosterVersion")
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Mosaic.Backend.Data.Entities.AuditLogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ActorRemoteAddress")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("actor_remote_address");

                    b.Property<Guid?>("ActorUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("actor_user_id");

                    b.Property<bool>("ActorWasErased")
                        .HasColumnType("boolean")
                        .HasColumnName("actor_was_erased");
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_audit_log_entries");

                    b.HasIndex("OccurredAt")
                        .HasDatabaseName("i_x_audit_log_entries_occurred_at");
            ...
            modelBuilder.Entity("Mosaic.Backend.Data.Entities.AuthChallenge", b =>
                {
                    ...
                    b.HasIndex("IpAddress", "IsUsed", "CreatedAt")
            ...
            modelBuilder.Entity("Mosaic.Backend.Data.Entities.EpochKey", b =>
                {
                    ...
                    b.HasIndex("AlbumId", "EpochId")
                        .HasDatabaseName("ix_epoch_keys_album_epoch");

                    b.HasIndex("AlbumId", "SignPubkey")
            ...
            modelBuilder.Entity("Mosaic.Backend.Data.Entities.IdempotencyRecord", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.Property<byte[]>("ResponseBodyHash")
                        .IsRequired()
                        .HasColumnType("bytea")
                        .HasColumnName("response_body_hash");

                    b.Property<string>("ResponseHeadersSubset")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("response_headers_subset");
                    ...
                    b.HasKey("UserId", "IdempotencyKey")
                        .HasName("p_k_idempotency_records");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("i_x_idempotency_records_created_at");
            ...
            modelBuilder.Entity("Mosaic.Backend.Data.Entities.User", b =>
                {
                    ...
                    b.Property<byte>("KdfAlgVersion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                        .HasDefaultValue((byte)19)
                        .HasColumnName("kdf_alg_version");
                    ...
                    b.Property<int>("SaltVersion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1)
                        .HasColumnName("salt_version");
            ...
            modelBuilder.Entity("Mosaic.Backend.Data.Entities.IdempotencyRecord", b =>
                {
                    b.HasOne("Mosaic.Backend.Data.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_idempotency_records__users_user_id");
