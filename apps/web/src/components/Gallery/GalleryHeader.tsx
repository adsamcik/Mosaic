...
export function GalleryHeader({
  ...
  return (
    <div
      className={`gallery-header ${isSelectionMode ? 'gallery-header--selection-mode' : ''}`}
    >
        ...
        {isSelectionMode ? (
          ...
          <>
            ...
            <div className="view-toggle" role="group" aria-label="View mode">
              ...
              <button
                className={`view-toggle-btn ${viewMode === 'story' ? 'view-toggle-btn--active' : ''}`}
                onClick={() => onViewModeChange('story')}
                aria-pressed={viewMode === 'story'}
                title={t('gallery.viewStory')}
                data-testid="view-toggle-story"
              >
                <span className="view-toggle-icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="view-toggle-label">{t('gallery.story')}</span>
              </button>
